...
(function() {
  ...
  msgs.invalidEmail = "Correo electrónico no válido; ej: tu.nombre@correo.es";
  msgs.selectColor = "Selecciona un color:";
  msgs.invalidPassword = ["La contraseña debe contener al menos ","numeros o letras"];
  msgs.invalidPasswordConfirmation = "las contraseñas son diferentes!";
  msgs.passwordStrength = "La contraseña es demasiado débil";
  msgs.capslockWarning = "Atención: bloqueo de mayúsculas activado";
  ...
  msgs.selectMonth = "- Seleccione un mes -";
