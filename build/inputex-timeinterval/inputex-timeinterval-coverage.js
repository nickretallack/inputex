...
YUI.add("inputex-timeinterval", function(Y){
   ...
   _yuitest_coverfunc("build/inputex-timeinterval/inputex-timeinterval.js", "(anonymous 2)", 6);
_yuitest_coverline("build/inputex-timeinterval/inputex-timeinterval.js", 8);
var lang = Y.Lang,
       inputEx = Y.inputEx;
 ...
 * </ul>
 */
_yuitest_coverline("build/inputex-timeinterval/inputex-timeinterval.js", 21);
inputEx.TimeIntervalField = function(options) {
   _yuitest_coverfunc("build/inputex-timeinterval/inputex-timeinterval.js", "TimeIntervalField", 21);
...
_yuitest_coverline("build/inputex-timeinterval/inputex-timeinterval.js", 24);
Y.extend(inputEx.TimeIntervalField, inputEx.CombineField, {   
   ...
   setOptions: function(options) {
      ...
      _yuitest_coverfunc("build/inputex-timeinterval/inputex-timeinterval.js", "setOptions", 30);
