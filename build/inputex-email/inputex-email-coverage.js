...
if (result && !!this.options.fixdomain) {
         _yuitest_coverline("build/inputex-email/inputex-email.js", 160);
...
result = this.validateNotDisposable();
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 168);
return result;
   ...
   getValue: function() {
      ...
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "getValue", 177);
_yuitest_coverline("build/inputex-email/inputex-email.js", 179);
var value;
      
      _yuitest_coverline("build/inputex-email/inputex-email.js", 181);
value = inputEx.EmailField.superclass.getValue.call(this);
      
      _yuitest_coverline("build/inputex-email/inputex-email.js", 183);
...
_yuitest_coverline("build/inputex-email/inputex-email.js", 189);
inputEx.registerType("email", inputEx.EmailField, []);


}, '@VERSION@', {"requires": ["inputex-string"], "lang": ["en", "fr", "de", "es", "fr", "it", "nl"], "ix_provides": "email"});
