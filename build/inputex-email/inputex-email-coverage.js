...
this.options.fixdomain = (Y.Lang.isUndefined(options.fixdomain) ? false : !!options.fixdomain);
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 38);
this.options.disallowDisposable = (Y.Lang.isUndefined(options.disallowDisposable) ? false : !!options.disallowDisposable);
    ...
    */
	validateDomain : function() {
		...
		_yuitest_coverfunc("build/inputex-email/inputex-email.js", "validateDomain", 45);
...
domain = val.split('@')[1];
		...
		_yuitest_coverline("build/inputex-email/inputex-email.js", 53);
domainList = [
...
if ( domain === groupDomain[j] ) {
						_yuitest_coverline("build/inputex-email/inputex-email.js", 101);
return true;
					}
				}
				else {_yuitest_coverline("build/inputex-email/inputex-email.js", 104);
if ( domain === groupDomain[j] ) {
...
Y.on("click",  function(e){
						_yuitest_coverfunc("build/inputex-email/inputex-email.js", "(anonymous 2)", 109);
...
var fixedVal = val.replace(reg, groupDomain[0]);
						_yuitest_coverline("build/inputex-email/inputex-email.js", 113);
...
this.messages.invalid = this.messages.didYouMean+"<a href='' id='"+linkId+"' style='color:blue;'>@"+groupDomain[0]+" ?</a>";
					...
					// field isnt valid
					_yuitest_coverline("build/inputex-email/inputex-email.js", 120);
return false;
				}}
			}
		}
		...
		// field is valid
		_yuitest_coverline("build/inputex-email/inputex-email.js", 126);
return true;
	},
   ...
   validateNotDisposable: function () {
      ...
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "validateNotDisposable", 132);
_yuitest_coverline("build/inputex-email/inputex-email.js", 134);
...
this.messages.invalid = this.messages.disposableEmail + email.match(disposableRegex)[0];
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 145);
return result;
   },
   ...
   validate: function() {
      ...
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "validate", 151);
_yuitest_coverline("build/inputex-email/inputex-email.js", 153);
if (!inputEx.EmailField.superclass.validate.call(this)) {
         _yuitest_coverline("build/inputex-email/inputex-email.js", 154);
return false;
      }
...
return true;
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 166);
...
return false;
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 171);
if (!!this.options.disallowDisposable && !this.validateNotDisposable()) {
         _yuitest_coverline("build/inputex-email/inputex-email.js", 172);
return false;
      }
      
      _yuitest_coverline("build/inputex-email/inputex-email.js", 175);
return true;
   ...
   getValue: function() {
      ...
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "getValue", 184);
...
value = inputEx.EmailField.superclass.getValue.call(this);
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 190);
...
_yuitest_coverline("build/inputex-email/inputex-email.js", 196);
