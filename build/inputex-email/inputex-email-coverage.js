...
YUI.add("inputex-email",function(Y){
  ...
  _yuitest_coverfunc("build/inputex-email/inputex-email.js", "(anonymous 2)", 6);
_yuitest_coverline("build/inputex-email/inputex-email.js", 8);
 ...
 */
_yuitest_coverline("build/inputex-email/inputex-email.js", 16);
inputEx.EmailField = function(options) {
   _yuitest_coverfunc("build/inputex-email/inputex-email.js", "EmailField", 16);
_yuitest_coverline("build/inputex-email/inputex-email.js", 17);
inputEx.EmailField.superclass.constructor.call(this,options);
};
_yuitest_coverline("build/inputex-email/inputex-email.js", 19);
Y.extend(inputEx.EmailField, inputEx.StringField, {
   ...
   setOptions: function(options) {
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "setOptions", 26);
_yuitest_coverline("build/inputex-email/inputex-email.js", 27);
inputEx.EmailField.superclass.setOptions.call(this, options);

      // Overwrite options
      _yuitest_coverline("build/inputex-email/inputex-email.js", 30);
this.options.messages.invalid = inputEx.messages.invalidEmail;
      _yuitest_coverline("build/inputex-email/inputex-email.js", 31);
this.options.regexp = inputEx.regexps.email;
      
      // Validate the domain name ( false by default )
      _yuitest_coverline("build/inputex-email/inputex-email.js", 34);
this.options.fixdomain = (Y.Lang.isUndefined(options.fixdomain) ? false : !!options.fixdomain);
      
      // Validate email is not disposable
      _yuitest_coverline("build/inputex-email/inputex-email.js", 37);
this.options.disallowDisposable = (Y.Lang.isUndefined(options.disallowDisposable) ? false : !!options.disallowDisposable);
    ...
    */
	validateDomain : function() {
		...
		_yuitest_coverfunc("build/inputex-email/inputex-email.js", "validateDomain", 44);
...
var i, j, val, domain, domainList, domainListLength, groupDomain, groupDomainLength;
		...
		_yuitest_coverline("build/inputex-email/inputex-email.js", 48);
val = this.getValue();
		_yuitest_coverline("build/inputex-email/inputex-email.js", 49);
domain = val.split('@')[1];
		
		// List of bad emails (only the first one in each array is the valid one)
		_yuitest_coverline("build/inputex-email/inputex-email.js", 52);
domainList = [
		...
		// Loop 1
		_yuitest_coverline("build/inputex-email/inputex-email.js", 89);
for(i=0, domainListLength = domainList.length; i<domainListLength; i++ ) {
			_yuitest_coverline("build/inputex-email/inputex-email.js", 90);
groupDomain = domainList[i];
			
			// Loop 2
			_yuitest_coverline("build/inputex-email/inputex-email.js", 93);
for(j=0, groupDomainLength = groupDomain.length; j<groupDomainLength; j++ ) {

				// First domain of array
				_yuitest_coverline("build/inputex-email/inputex-email.js", 96);
if (inputEx.indexOf(domain, groupDomain) === 0) {
					
					// If domain matches the first value of the array it means it's valid
					_yuitest_coverline("build/inputex-email/inputex-email.js", 99);
if ( domain === groupDomain[j] ) {
						_yuitest_coverline("build/inputex-email/inputex-email.js", 100);
return true;
					}
				}
				else {_yuitest_coverline("build/inputex-email/inputex-email.js", 103);
if ( domain === groupDomain[j] ) {
					_yuitest_coverline("build/inputex-email/inputex-email.js", 104);
var linkId = Y.guid();
					_yuitest_coverline("build/inputex-email/inputex-email.js", 105);
var that = this;
...
Y.on("click",  function(e){
						_yuitest_coverfunc("build/inputex-email/inputex-email.js", "(anonymous 3)", 108);
...
var reg = new RegExp(domain, "i");
						_yuitest_coverline("build/inputex-email/inputex-email.js", 111);
var fixedVal = val.replace(reg, groupDomain[0]);
						_yuitest_coverline("build/inputex-email/inputex-email.js", 112);
that.setValue( fixedVal );
					}, '#' + linkId, this);
					
					// Display the message with the link
					_yuitest_coverline("build/inputex-email/inputex-email.js", 116);
this.options.messages.invalid = inputEx.messages.didYouMean+"<a href='' id='"+linkId+"' style='color:blue;'>@"+groupDomain[0]+" ?</a>";
					
					// field isnt valid
					_yuitest_coverline("build/inputex-email/inputex-email.js", 119);
return false;
				}}
			}
		}
		...
		// field is valid
		_yuitest_coverline("build/inputex-email/inputex-email.js", 125);
return true;
	},
   ...
   validateNotDisposable: function () {
      ...
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "validateNotDisposable", 131);
_yuitest_coverline("build/inputex-email/inputex-email.js", 133);
var email = this.getValue(),
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 137);
result = !email.match(disposableRegex);
      
      // change invalid message
      _yuitest_coverline("build/inputex-email/inputex-email.js", 140);
if (!result) {
         _yuitest_coverline("build/inputex-email/inputex-email.js", 141);
this.options.messages.invalid = inputEx.messages.disposableEmail + email.match(disposableRegex)[0];
      }
      
      _yuitest_coverline("build/inputex-email/inputex-email.js", 144);
return result;
   },
   ...
   validate: function() {
      ...
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "validate", 150);
_yuitest_coverline("build/inputex-email/inputex-email.js", 152);
var result = inputEx.EmailField.superclass.validate.call(this);
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 155);
this.options.messages.invalid = inputEx.messages.invalidEmail;
      
      // if we want the domain validation
      _yuitest_coverline("build/inputex-email/inputex-email.js", 158);
if (result && !!this.options.fixdomain) {
         _yuitest_coverline("build/inputex-email/inputex-email.js", 159);
result = this.validateDomain();
      }
      
      // if we want to disallow disposable e-mail addresses
      _yuitest_coverline("build/inputex-email/inputex-email.js", 163);
if (result && !!this.options.disallowDisposable) {
         _yuitest_coverline("build/inputex-email/inputex-email.js", 164);
result = this.validateNotDisposable();
      }
      
      _yuitest_coverline("build/inputex-email/inputex-email.js", 167);
return result;
   ...
   getValue: function() {
      ...
      _yuitest_coverfunc("build/inputex-email/inputex-email.js", "getValue", 176);
...
value = inputEx.EmailField.superclass.getValue.call(this);
      ...
      _yuitest_coverline("build/inputex-email/inputex-email.js", 182);
...
_yuitest_coverline("build/inputex-email/inputex-email.js", 188);
