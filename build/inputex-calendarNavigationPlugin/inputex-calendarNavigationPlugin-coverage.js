...
this.get("panel").show();
    ...
    _prepareMonthsData: function() {
        ...
        _yuitest_coverfunc("build/inputex-calendarNavigationPlugin/inputex-calendarNavigationPlugin.js", "_prepareMonthsData", 154);
...
return monthsField;
    ...
    _isPanelVisible: function() {
        ...
        _yuitest_coverfunc("build/inputex-calendarNavigationPlugin/inputex-calendarNavigationPlugin.js", "_isPanelVisible", 177);
...
return panel ? panel.get("visible") : false;
    ...
    ATTRS: {
        ...
        string: {
            valueFn: function() {
                _yuitest_coverfunc("build/inputex-calendarNavigationPlugin/inputex-calendarNavigationPlugin.js", "valueFn", 200);
