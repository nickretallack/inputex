...
YUI.add("inputex-date", function(Y){
   ...
   _yuitest_coverfunc("build/inputex-date/inputex-date.js", "(anonymous 2)", 6);
_yuitest_coverline("build/inputex-date/inputex-date.js", 8);
var lang = Y.Lang,
       inputEx = Y.inputEx;
 ...
 * </ul>
 */
_yuitest_coverline("build/inputex-date/inputex-date.js", 22);
inputEx.DateField = function(options) {
	_yuitest_coverfunc("build/inputex-date/inputex-date.js", "DateField", 22);
_yuitest_coverline("build/inputex-date/inputex-date.js", 23);
inputEx.DateField.superclass.constructor.call(this,options);
};
	
_yuitest_coverline("build/inputex-date/inputex-date.js", 26);
Y.extend(inputEx.DateField, inputEx.StringField, {
   ...
   setOptions: function(options) {
   	_yuitest_coverfunc("build/inputex-date/inputex-date.js", "setOptions", 32);
_yuitest_coverline("build/inputex-date/inputex-date.js", 33);
inputEx.DateField.superclass.setOptions.call(this, options);
   	
   	// Overwrite options
   	_yuitest_coverline("build/inputex-date/inputex-date.js", 36);
...
this.options.messages.invalid = options.invalidDate ? options.invalidDate : inputEx.messages.invalidDate;
   	...
   	// Added options
   	_yuitest_coverline("build/inputex-date/inputex-date.js", 40);
