...
_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 101);
var values;
			
			_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 103);
if (this.isEmpty()) {
...
values = inputEx.DateSelectMonthField.superclass.getValue.call(this);
			...
			_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 110);
...
return new Date(NaN, NaN, NaN); // -> Invalid Date (Firefox) or NaN (IE) (both instanceof Date ...)
			...
			_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 114);
return new Date(parseInt(values[this.yearIndex], 10), values[this.monthIndex], parseInt(values[this.dayIndex], 10));
		...
		validate: function () {
			...
			_yuitest_coverfunc("build/inputex-dateselectmonth/inputex-dateselectmonth.js", "validate", 120);
_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 122);
var val = this.getValue();
			
			// empty field
			_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 125);
if (val === '') {
				// validate only if not required
				_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 127);
...
return (val instanceof Date && lang.isNumber(val.getTime()));
		 ...
		 */
		isEmpty: function () {
			_yuitest_coverfunc("build/inputex-dateselectmonth/inputex-dateselectmonth.js", "isEmpty", 143);
_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 144);
var values = inputEx.DateSelectMonthField.superclass.getValue.call(this);
			_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 145);
return (values[this.monthIndex] === -1 && values[this.yearIndex] === "" &&  values[this.dayIndex] === "");
	...
	_yuitest_coverline("build/inputex-dateselectmonth/inputex-dateselectmonth.js", 151);
