...
this.docClickHandler = Y.on('click', Y.bind(function(e) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 2)", 149);
...
updateMethod.call(this, id, fieldValues, Y.bind(function(success) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 3)", 193);
...
data.each(function (model) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 4)", 218);
...
button.on("click", function(e) {
            ...
            _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 5)", 262);
...
deleteMethod.call(this, record, Y.bind(function(success) {
            _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 6)", 308);
...
updateMethod.call(this, fieldValues.id, fieldValues, Y.bind(function(success) {
            _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 7)", 394);
...
addMethod.call(this, record, Y.bind(function(success) {
            _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 8)", 416);
...
data.each(function (model) {
         ...
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 9)", 438);
...
host.addColumn({
   ...
   addDeleteColumn: function() {
      ...
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "addDeleteColumn", 525);
...
host.addColumn({
   ...
   removeModifyColumn: function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "removeModifyColumn", 540);
...
this.get("host").removeColumn("modify");
   ...
   removeDeleteColumn: function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "removeDeleteColumn", 549);
...
this.get("host").removeColumn("delete");
   ...
   generateId : function(size) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "generateId", 554);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 555);
...
return prefixId + Math.floor(Math.random()*Math.pow(10,s));
   ...
   _initStrings : function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "_initStrings", 561);
...
ATTRS: {
   ...
   addMethod: {
      value: function(record, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 693);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 694);
cb(true);
      }
   },
   ...
   updateMethod: {
      value: function(id, newValues, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 706);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 707);
cb(true);
      }
   },
   ...
   deleteMethod: {
      value: function(record, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 719);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 720);
cb(true);
      }
   }
