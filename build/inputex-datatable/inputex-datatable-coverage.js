...
addMethod.call(this, record, Y.bind(function(success) {
            _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 9)", 475);
...
this.disableSaveButton(false);
   ...
   disableSaveButton : function(bool) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "disableSaveButton", 492);
...
button.set('disabled', bool);
   ...
   destructor: function() {
      ...
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "destructor", 501);
...
data.each(function (model) {
         ...
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 10)", 507);
...
this.get("panel").destroy();
   ...
   addModifyAttr: function(model) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "addModifyAttr", 543);
...
model.addAttr("modify");
   ...
   addDeleteAttr: function (model) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "addDeleteAttr", 552);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 553);
model.addAttr("delete");
   ...
   delModifyAttr: function(model) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "delModifyAttr", 561);
...
model.removeAttr("modify");
   ...
   delDeleteAttr: function (model) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "delDeleteAttr", 570);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 571);
model.removeAttr("delete");
   ...
   addModifyColumn: function() {
      ...
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "addModifyColumn", 579);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 581);
var host = this.get('host');
         
      _yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 583);
host.addColumn({
         label: ' ',
   ...
   addDeleteColumn: function() {
      ...
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "addDeleteColumn", 598);
...
host.addColumn({
   ...
   removeModifyColumn: function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "removeModifyColumn", 616);
...
this.get("host").removeColumn("modify");
   ...
   removeDeleteColumn: function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "removeDeleteColumn", 625);
...
this.get("host").removeColumn("delete");
   ...
   generateId : function(size) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "generateId", 630);
...
return prefixId + Math.floor(Math.random()*Math.pow(10,s));
   ...
   _addEditedClass: function (record) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "_addEditedClass", 637);
...
if (record instanceof Y.Node) {
         _yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 640);
...
host.getRow(record).addClass(host.getClassName('row-edited'));
   ...
   _removeEditedClass: function (record, now) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "_removeEditedClass", 647);
...
Y.later(now === true ? 0 : (Y.Lang.isNumber(now) ? now : 5000), this, function () {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 11)", 648);
...
row.removeClass(host.getClassName('row-edited'));
   ...
   _initStrings : function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "_initStrings", 662);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 663);
...
ATTRS: {
   ...
   addMethod: {
      value: function(record, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 803);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 804);
cb(true);
      }
   },
   ...
   updateMethod: {
      value: function(id, newValues, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 816);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 817);
cb(true);
      }
   },
   ...
   deleteMethod: {
      value: function(record, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 829);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 830);
cb(true);
      }
   },
