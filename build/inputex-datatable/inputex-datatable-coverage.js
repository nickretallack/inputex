...
row.removeClass(host.getClassName('row-edited'));
   ...
   _initStrings : function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "_initStrings", 627);
...
cb(true);
   ...
   updateMethod: {
      value: function(id, newValues, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 781);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 782);
cb(true);
      }
   },
   ...
   deleteMethod: {
      value: function(record, cb) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "value", 794);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 795);
cb(true);
      }
   },
