...
this.onOverlayCancel();
   ...
   onOverlayCancel: function() {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "onOverlayCancel", 245);
...
this.docKeyListener.detach();
   ...
   enrichData: function () {
      ...
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "enrichData", 255);
...
data.each(function (model) {
         _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "(anonymous 7)", 260);
...
that.addDeleteAttr(model);
   ...
   enrichColumns: function () {
      ...
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "enrichColumns", 276);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 278);
if(!this.get("disableModifyFunc")) {
...
this.addDeleteColumn();
   ...
   addAddButton: function() {
      ...
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "addAddButton", 292);
_yuitest_coverline("build/inputex-datatable/inputex-datatable.js", 294);
...
this.addButtonBottom.on("click", this._onAddButtonClick, this);
   ...
   _onAddButtonClick: function (e) {
      _yuitest_coverfunc("build/inputex-datatable/inputex-datatable.js", "_onAddButtonClick", 314);
