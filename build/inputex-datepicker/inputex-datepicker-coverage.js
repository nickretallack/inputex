...
this.calendarRendered = true;
   ...
   */
   beforeShowOverlay: function() {
      ...
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "beforeShowOverlay", 197);
...
this.calendar._renderSelectedDates();       // need to be called explicitely since selectionChange is had not been fired
    ...
    */
   close: function() {
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "close", 225);
...
this.oOverlay.hide();
    ...
    */
   disable: function() {
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "disable", 235);
...
this.button.set('disabled', true);
    ...
    */
   enable: function() {
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "enable", 244);
_yuitest_coverline("build/inputex-datepicker/inputex-datepicker.js", 245);
inputEx.DatePickerField.superclass.enable.call(this);
      _yuitest_coverline("build/inputex-datepicker/inputex-datepicker.js", 246);
