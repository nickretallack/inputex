...
this.calendar._addDateToSelection(date, 1); // pass 1    so that selectionChange event is not fired
    ...
    */
   close: function() {
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "close", 213);
...
this.oOverlay.hide();
    ...
    */
   disable: function() {
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "disable", 223);
...
this.button.set('disabled', true);
    ...
    */
   enable: function() {
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "enable", 232);
...
this.button.set('disabled', false);
   ...
   isDatePickerButton : function(Ynode){
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "isDatePickerButton", 241);
...
_yuitest_coverline("build/inputex-datepicker/inputex-datepicker.js", 250);
