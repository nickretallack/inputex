...
this.outsideHandler = this.oOverlay.get('boundingBox').on('mousedownoutside', function (e) {
              ...
              _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "(anonymous 3)", 71);
...
if(this.outsideHandler){
              _yuitest_coverline("build/inputex-datepicker/inputex-datepicker.js", 82);
this.outsideHandler.detach();
   ...
   _toggleOverlay: function() {
      ...
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "_toggleOverlay", 94);
...
this.renderOverlay();
         _yuitest_coverline("build/inputex-datepicker/inputex-datepicker.js", 101);
this.renderCalendar();
      }
...
this.oOverlay[method]();
   ...
   renderComponent: function() {
      ...
      _yuitest_coverfunc("build/inputex-datepicker/inputex-datepicker.js", "renderComponent", 112);
