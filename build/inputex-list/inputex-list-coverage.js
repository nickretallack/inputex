...
YUI.add("inputex-list",function(Y){
   ...
   _yuitest_coverfunc("build/inputex-list/inputex-list.js", "(anonymous 2)", 6);
_yuitest_coverline("build/inputex-list/inputex-list.js", 8);
var lang = Y.Lang,
       inputEx = Y.inputEx;
 ...
 * </ul>
 */
_yuitest_coverline("build/inputex-list/inputex-list.js", 28);
inputEx.ListField = function(options) {
    ...
    * @property subFields
    */
   _yuitest_coverfunc("build/inputex-list/inputex-list.js", "ListField", 28);
...
_yuitest_coverline("build/inputex-list/inputex-list.js", 38);
Y.extend(inputEx.ListField,inputEx.Field, {
	...
	setOptions: function(options) {
	   _yuitest_coverfunc("build/inputex-list/inputex-list.js", "setOptions", 54);
...
this.arrowAnim.on("end",function() { _yuitest_coverfunc("build/inputex-list/inputex-list.js", "(anonymous 3)", 349);
...
this.arrowAnim.on("end",function() { _yuitest_coverfunc("build/inputex-list/inputex-list.js", "(anonymous 4)", 397);
Y.one(insertedEl).setStyle( 'backgroundColor', ''); });
