...
var CONFIG = {
   ...
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 673);
if (typeof YUI_config === 'undefined') {
      _yuitest_coverline("build/inputex-loader/inputex-loader.js", 674);
YUI_config = {groups: {}};
   }
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 676);
if (typeof YUI_config.groups === 'undefined') {
      _yuitest_coverline("build/inputex-loader/inputex-loader.js", 677);
YUI_config.groups = {};
   }
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 679);
Y.mix(YUI_config.groups, CONFIG.groups);

   // Loop through all modules
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 682);
var modules = YUI_config.groups.inputex.modules,
       allModules = [],
       modulesByType = {};
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 685);
for(var moduleName in modules) {
     _yuitest_coverline("build/inputex-loader/inputex-loader.js", 686);
if (modules.hasOwnProperty(moduleName) ) {
       
       // Build a list of all inputEx modules
       _yuitest_coverline("build/inputex-loader/inputex-loader.js", 689);
allModules.push(moduleName);
       
       // Build a reverse index on which module provides what type
       _yuitest_coverline("build/inputex-loader/inputex-loader.js", 692);
if(modules[moduleName].ix_provides) {
          _yuitest_coverline("build/inputex-loader/inputex-loader.js", 693);
modulesByType[modules[moduleName].ix_provides] = moduleName;
       }
       
     }
   }
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 698);
YUI_config.groups.inputex.allModules = allModules;
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 699);
