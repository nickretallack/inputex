...
if (typeof YUI_config === 'undefined') {
      _yuitest_coverline("build/inputex-loader/inputex-loader.js", 786);
YUI_config = {groups: {}};
   }
...
YUI_config.groups = {};
   ...
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 791);
...
var modules = YUI_config.groups.inputex.modules,
       allModules = [],
       modulesByType = {};
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 797);
for(var moduleName in modules) {
     _yuitest_coverline("build/inputex-loader/inputex-loader.js", 798);
if (modules.hasOwnProperty(moduleName) ) {
       
       // Build a list of all inputEx modules
       _yuitest_coverline("build/inputex-loader/inputex-loader.js", 801);
allModules.push(moduleName);
       
       // Build a reverse index on which module provides what type
       _yuitest_coverline("build/inputex-loader/inputex-loader.js", 804);
if(modules[moduleName].ix_provides) {
          _yuitest_coverline("build/inputex-loader/inputex-loader.js", 805);
=======
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 771);
if (typeof YUI_config === 'undefined') {
      _yuitest_coverline("build/inputex-loader/inputex-loader.js", 772);
YUI_config = {groups: {}};
   }
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 774);
if (typeof YUI_config.groups === 'undefined') {
      _yuitest_coverline("build/inputex-loader/inputex-loader.js", 775);
YUI_config.groups = {};
   }
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 777);
Y.mix(YUI_config.groups, CONFIG.groups);

   // Loop through all modules
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 780);
var modules = YUI_config.groups.inputex.modules,
       allModules = [],
       modulesByType = {};
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 783);
for(var moduleName in modules) {
     _yuitest_coverline("build/inputex-loader/inputex-loader.js", 784);
if (modules.hasOwnProperty(moduleName) ) {
       
       // Build a list of all inputEx modules
       _yuitest_coverline("build/inputex-loader/inputex-loader.js", 787);
allModules.push(moduleName);
       
       // Build a reverse index on which module provides what type
       _yuitest_coverline("build/inputex-loader/inputex-loader.js", 790);
if(modules[moduleName].ix_provides) {
          _yuitest_coverline("build/inputex-loader/inputex-loader.js", 791);
>>>>>>> [inputex-calendarNavigationPlugin] done
...
<<<<<<< HEAD
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 810);
YUI_config.groups.inputex.allModules = allModules;
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 811);
=======
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 796);
YUI_config.groups.inputex.allModules = allModules;
   _yuitest_coverline("build/inputex-loader/inputex-loader.js", 797);
>>>>>>> [inputex-calendarNavigationPlugin] done
