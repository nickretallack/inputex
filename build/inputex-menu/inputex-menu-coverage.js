...
this._menu.appendTo(container);
    ...
    */
   initEvents: function() {
      _yuitest_coverfunc("build/inputex-menu/inputex-menu.js", "initEvents", 184);
_yuitest_coverline("build/inputex-menu/inputex-menu.js", 185);
this._menu.delegate('click', Y.bind(this.onItemClick, this), 'a');
   ...
   onItemClick: function(e) {
      _yuitest_coverfunc("build/inputex-menu/inputex-menu.js", "onItemClick", 191);
...
this._menu.menuNav._hideAllSubmenus(this._menu.menuNav._rootMenu);
    ...
    */
   getValue: function() {
      _yuitest_coverfunc("build/inputex-menu/inputex-menu.js", "getValue", 213);
...
return this.hiddenEl.value;
   ...
   setValue: function(value, sendUpdatedEvt) {
      // update text
      _yuitest_coverfunc("build/inputex-menu/inputex-menu.js", "setValue", 220);
...
this.hiddenEl.value = (!!this._textFromValue[value]) ? value : '';
      _yuitest_coverline("build/inputex-menu/inputex-menu.js", 226);
