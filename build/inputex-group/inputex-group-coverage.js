...
for(var j = 0 ; j < interaction.actions.length ; j++) {
               _yuitest_coverline("build/inputex-group/inputex-group.js", 442);
this.runAction(interaction.actions[j], fieldValue);
   ...
   runFieldsInteractions: function() {
      _yuitest_coverfunc("build/inputex-group/inputex-group.js", "runFieldsInteractions", 453);
...
this.runInteractions(this.inputs[i],this.inputs[i].getValue());
	...
	clear: function(sendUpdatedEvt) {
	   _yuitest_coverfunc("build/inputex-group/inputex-group.js", "clear", 466);
...
if(sendUpdatedEvt !== false) {
	      // fire update event
         _yuitest_coverline("build/inputex-group/inputex-group.js", 472);
this.fireUpdatedEvt();
      }
	},
	...
	setErrors: function(errors) {	
		_yuitest_coverfunc("build/inputex-group/inputex-group.js", "setErrors", 481);
...
Y.one(this.inputsNames[k].divEl).replaceClass("inputEx-valid", "inputEx-invalid" );
		...
		else {_yuitest_coverline("build/inputex-group/inputex-group.js", 495);
...
this.inputsNames[k].displayMessage(errors[k]);
							_yuitest_coverline("build/inputex-group/inputex-group.js", 501);
Y.one(this.inputsNames[k].divEl).replaceClass("inputEx-valid", "inputEx-invalid" );
						}
					}
				}
    ...
    */
    setFieldName: function(name){
			_yuitest_coverfunc("build/inputex-group/inputex-group.js", "setFieldName", 513);
...
for (var i = 0; i < l; i++){
				_yuitest_coverline("build/inputex-group/inputex-group.js", 516);
this.inputs[i].setFieldName(name+""+((this.inputs[i].el && this.inputs[i].el.name )|| "group-"+i ));
   ...
   destroy: function() {
      ...
      _yuitest_coverfunc("build/inputex-group/inputex-group.js", "destroy", 524);
...
field.destroy();
      ...
      _yuitest_coverline("build/inputex-group/inputex-group.js", 535);
...
_yuitest_coverline("build/inputex-group/inputex-group.js", 544);
