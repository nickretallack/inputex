...
this.previousState = state;
   ...
   getStateString: function(state) {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "getStateString", 255);
...
return this.messages.required;
      } else {_yuitest_coverline("build/inputex-field/inputex-field.js", 258);
...
return '';
   ...
   getState: function() {
      ...
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "getState", 270);
...
return this.options.required ? inputEx.stateRequired : inputEx.stateEmpty;
      ...
      _yuitest_coverline("build/inputex-field/inputex-field.js", 275);
return this.validate() ? inputEx.stateValid : inputEx.stateInvalid;
    ...
    */
   validate: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "validate", 283);
...
return true;
    ...
    */
   onFocus: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "onFocus", 292);
...
el.removeClass('inputEx-empty');
      _yuitest_coverline("build/inputex-field/inputex-field.js", 295);
el.addClass('inputEx-focused');
    ...
    */
   onBlur: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "onBlur", 303);
...
Y.one(this.getEl()).removeClass('inputEx-focused');
      ...
      _yuitest_coverline("build/inputex-field/inputex-field.js", 307);
this.setClassFromState();
   },
    ...
    */
   onChange: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "onChange", 315);
_yuitest_coverline("build/inputex-field/inputex-field.js", 316);
this.fireUpdatedEvt();
   },
    ...
    */
   isDisabled: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "isDisabled", 341);
_yuitest_coverline("build/inputex-field/inputex-field.js", 342);
return false;
   },
    ...
    */
   destroy: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "destroy", 355);
...
Y.Event.purgeElement(el, true);
      ...
      // Remove from DOM
      _yuitest_coverline("build/inputex-field/inputex-field.js", 366);
if(Y.one(el).inDoc()) {
...
el.parentNode.removeChild(el);
   ...
   displayMessage: function(msg) {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "displayMessage", 377);
...
return;
      ...
      _yuitest_coverline("build/inputex-field/inputex-field.js", 381);
if(!this.msgEl) {
...
this.msgEl.innerHTML = msg;
    ...
    */
   show: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "show", 400);
...
this.divEl.style.display = '';
    ...
    */
   hide: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "hide", 408);
...
this.divEl.style.display = 'none';
   ...
   clear: function(sendUpdatedEvt) {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "clear", 418);
...
this.setValue(lang.isUndefined(this.options.value) ? '' : this.options.value, sendUpdatedEvt);
    ...
    */
   isEmpty: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "isEmpty", 426);
...
return this.getValue() === '';
   ...
   setParentField: function(parentField) {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "setParentField", 436);
_yuitest_coverline("build/inputex-field/inputex-field.js", 437);
this.parentField = parentField;
   ...
   getParentField: function() {
      _yuitest_coverfunc("build/inputex-field/inputex-field.js", "getParentField", 445);
_yuitest_coverline("build/inputex-field/inputex-field.js", 446);
...
_yuitest_coverline("build/inputex-field/inputex-field.js", 453);
